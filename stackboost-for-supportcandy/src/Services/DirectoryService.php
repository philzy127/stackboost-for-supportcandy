...
class DirectoryService {
	...
	public function get_formatted_phone_numbers_html( \stdClass $employee ): string {
		...
		if ( ! empty( $employee->mobile_phone ) ) {
			...
			$mobile_line = '<span class="dashicons dashicons-smartphone" style="font-size: 16px; width: 16px; height: 16px; vertical-align: middle; margin-right: 5px; color: #555; transform: scale(1.4);" title="' . esc_attr__( 'Mobile', 'stackboost-for-supportcandy' ) . '"></span>' . $mobile_link;
