		...
		switch ( $column_name ) {
			case 'stackboost_contact_phone':
				...
				if ( ! empty( $mobile_phone ) ) {
					...
					$output .= '<span class="dashicons dashicons-smartphone" style="font-size: 22px; width: 22px; height: 22px; vertical-align: middle; margin-right: 5px; color: #555;" title="' . esc_attr__( 'Mobile', 'stackboost-for-supportcandy' ) . '"></span>' . esc_html( $formatted_mobile );
				}
