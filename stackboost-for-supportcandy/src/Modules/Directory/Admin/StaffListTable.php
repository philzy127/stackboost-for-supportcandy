		...
		switch ( $column_name ) {
			case 'stackboost_contact_phone':
				...
				if ( ! empty( $mobile_phone ) ) {
					...
					$output .= '<span class="dashicons dashicons-smartphone" style="display: inline-block; font-size: 16px; width: 16px; height: 16px; vertical-align: middle; margin-right: 5px; color: #555; transform: scale(1.4);" title="' . esc_attr__( 'Mobile', 'stackboost-for-supportcandy' ) . '"></span>' . esc_html( $formatted_mobile );
				}
